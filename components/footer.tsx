        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-300">
              ...
              <a href={'mailto:' + email} className="block hover:opacity-80 transition-opacity">
                {email}
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-300">
              ...
              <Link href={'/' + locale + '/about'} className="block hover:opacity-80 transition-opacity">
                {t('links.about')}
              </Link>
              <Link href={'/' + locale + '/board'} className="block hover:opacity-80 transition-opacity">
                {t('links.board')}
              </Link>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-300">
              <a href={linkedinUrl} target="_blank" rel="noopener noreferrer" className="block hover:opacity-80 transition-opacity">
                LinkedIn
              </a>
              <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="block hover:opacity-80 transition-opacity">
                Instagram
              </a>
            </div>
          </div>
